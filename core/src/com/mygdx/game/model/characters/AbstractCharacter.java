...
import com.mygdx.game.model.armors.AbstractArmor;
import com.mygdx.game.model.characters.attributes.AbstractAttribute;
import com.mygdx.game.model.characters.cultures.AbstractCulture;
import com.mygdx.game.model.characters.proficiencies.AbstractProficiency;
import com.mygdx.game.model.characters.proficiencies.util.ProficiencyType;
import com.mygdx.game.model.util.Roller;
import com.mygdx.game.model.weapons.AbstractMeleeWeapon;
import com.mygdx.game.model.weapons.util.WoundType;
...
public class AbstractCharacter {
  ...
  private int attemptHit(String attackType, int expendedMeleePool) {
    ...
    final List<Integer> rolls = Roller.getInstance().rollD12(expendedMeleePool);
